...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pointnet_partseg', help='model name [default: pointnet_partseg]')
    parser.add_argument('--gpu', type=str, default='0', help='specify gpu device [default: 0]')
    parser.add_argument('--num_point', type=int, default=2048, help='Point Number [default: 2048]')
    parser.add_argument('--log_dir', type=str, default='pointnet_part_seg', help='Experiment root')
...
def main(args):
    ...
    '''MODEL LOADING'''
    if args.model_mode is None or args.model is None:
        model_name = os.listdir(experiment_dir+'/logs')[0].split('.')[0]
    else:
        model_name = args.model_mode + '.' + args.model
